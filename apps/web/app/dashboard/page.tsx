  ...
  return (
    <main className="p-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        {[{label:"Active Agents",value:"\u2013"},{label:"Workflows Run",value:"\u2013"},{label:"API Requests",value:"\u2013"}].map(({label,value})=>(<div key={label} className="rounded-lg border border-gray-700 bg-gray-900 p-6"><p className="text-sm text-gray-400">{label}</p><p className="mt-2 text-4xl font-bold text-blue-400">{value}</p></div>))}
      </div>
